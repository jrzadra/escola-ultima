...
class ResponsavelTest {
    ...
    void setUp() {
        ...
        Responsavel responsavel1 = new Responsavel("Carlos Moreira");
        Responsavel responsavel2 = new Responsavel("Amanda Castro");
        Responsavel responsavel3 = new Responsavel("Jonas Fagundes");
    }
